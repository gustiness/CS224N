...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        input_placeholder = tf.placeholder(tf.float32, (Config.batch_size, Config.n_features))
        labels_placeholder = tf.placeholder(tf.float32, (Config.batch_size,Config.n_classes))
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        grad = tf.train.GradientDescentOptimizer(self.config.lr)
